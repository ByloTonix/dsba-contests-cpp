...
//     addCitation(citations, CitationType::Article, dataArticle);
//     std::string text = "The work was referenced in {art1} and {wp2}. Later, authors of {wp2} released another article, criticizing {art1}.\n";
...
void test6()
{
    ...
    std::string text = "The work was referenced in {art1} and {art2}. Later, authors of {wp3} released another article, criticizing {art2}.\n";
